		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comiherbtmztmiherbfreightorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiherbtmztmiherbfreightorders-display": {
								"semanticObject": "comiherbtmztmiherbfreightorders",
								"action": "display",
								"description": "Vendor Portal - Freight Orders",
								"title": "Freight Orders",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iherb.tm.ztmiherbfreightorders",
									"url": sap.ui.require.toUrl("com/iherb/tm/ztmiherbfreightorders")
								}
							}
						}
					}
